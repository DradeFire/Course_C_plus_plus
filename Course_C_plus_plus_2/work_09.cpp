...
void Test3() {
    ...
    for (int year : {1900, 1965, 1990}) {
        test_s.push_back(person.GetFullName(year));
    }
    ...
    Assert(test_s.at(0) == "Incognito" && test_s.at(1) == "Polina with unknown last name"
        && test_s.at(2) == "Polina Sergeeva" && test_s.at(3) == "Polina Sergeeva"
        && test_s.at(4) == "Appolinaria Sergeeva" && test_s.at(5) == "Polina Volkova"
        && test_s.at(6) == "Appolinaria Volkova", "test#3");
}
